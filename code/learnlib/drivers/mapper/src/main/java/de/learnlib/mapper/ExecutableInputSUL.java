...
public class ExecutableInputSUL<I extends ExecutableInput<? extends O>, O> implements SUL<I, O> {
    ...
    @Override
    public O step(I in) throws SULException { // Invokes the method call
        return in.execute();
    }

    public O[] stepMultiple(I in) throws SULException { // Invokes the method call
        return in.executeMultiple();
    }
