 ...
 * de.learnlib.modelchecking.modelchecker.LTSminLTLIO<I,O>
 */
...
public final class LTSminLTLIOBuilder<
	...
	private static<
			I extends java.lang.Object,
			O extends java.lang.Object> de.learnlib.modelchecking.modelchecker.LTSminLTLIO<I,O> $createDispatch(
		boolean keepFiles,
		...
		return new de.learnlib.modelchecking.modelchecker.LTSminLTLIO<I,O>(
			keepFiles,
			string2Input,
			string2Output,
			minimumUnfolds,
	...
	public de.learnlib.modelchecking.modelchecker.LTSminLTLIO<I,O> create() {
	...
	public LTSminLTLIOBuilder<I, O> withString2Input(java.util.function.Function<java.lang.String,I> string2Input) {
		this.string2Input = string2Input;
		return this;
	} 
	...
	public LTSminLTLIOBuilder<I, O> withString2Output(java.util.function.Function<java.lang.String,O> string2Output) {
		this.string2Output = string2Output;
		return this;
	} 
	...
	public LTSminLTLIOBuilder<I, O> withSkipOutputs(java.util.Collection<? super O> skipOutputs) {
		this.skipOutputs = skipOutputs;
		return this;
	} 
